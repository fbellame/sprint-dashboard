# Sprint 0: Team Lead Quick Reference
...
- [Daily Notes](./SPRINT_0_DAILY_NOTES.md) - Standup notes
...
- [Frontend Dev 1 Guide](./SPRINT_0_FRONTEND_DEV1.md) - Frontend dev 1 guide
...
4. [ ] Prepare for sprint retrospective

---

## 🎯 Review Priorities

1. **Story 0.1** (Critical) - Review immediately
2. **Story 0.2** (High) - Review within 4 hours
